<template>
  <div class="item flex space-x-0 sm:space-x-5 sm:flex-row flex-col sm:w-auto sm:h-auto w-[345px]" :col="col">
    ...
    <router-link to="/Active/:id">
      <img :src="img" class="activeImg w-[350px] h-[200] rounded-xl sm:rounded-3xl cursor-pointer" :style="imgWidth">
    </router-link>
    <div class="activeContent flex flex-col justify-center w-full">
      ...
      <div class="flex justify-between items-center">
        ...
        <div class="activeJoin sm:hidden flex justify-center items-center border-2 bg-orange hover:bg-transparent border-orange  rounded-[20px] w-[65px] h-[25px] text-[14px] text-white hover:text-orange pt-[1px]">想參加</div>
      </div>
      <div >
