  ...
  <div class="messageAll space-y-5">
    <div class="messageWrite space-y-5">
        ...
        <div class="flex items-center sm:space-x-5 space-x-1">
            ...
            <textarea v-model="inputMessage" class="write text-sm text-gray-dark rounded-xl border-2 px-4 py-2 placeholder-gray-light focus:placeholder-opacity-0  border-gray-default focus:border-orange"
                    placeholder="新增留言…
留言內容含有污辱謾罵、人身攻擊、色情...等不當字眼字眼，管理員有權利刪除留言！"></textarea>
            <div class="sm:space-x-2 space-x-0 flex">
              <button @click="clearInput" class="rounded-3xl border-2 border-gray-default  text-sm text-gray-dark hover:text-orange hover:border-orange sm:block hidden">取消</button>
