      ...
      <ul>
        <li class="li_area_two">
          ...
          <ul class="ul_control" v-if="mCollapse">
            <li
              class="li_inside_title"
              v-for="(item, index) in navMemberList"
              :key="index"
            >
              <a :href="item.link">{{ item.name }}</a>
            </li>
      ...
      <ul class="ul_musician">
        <li class="li_area_two">
          ...
          <ul class="ul_control" v-if="cCollapse">
            <li
              class="li_inside_title"
              v-for="(item, index) in navMusicianList"
              :key="index"
            >
              <a :href="item.link">{{ item.name }}</a>
            </li>
  ...
  data () {
    return {
      ...
      navList: [
        {
          name: '發現',
          icon: require('../../assets/icon/nav/loupe.svg'),
          link: 'https://tw.yahoo.com/'
        },
        {
          name: '排行榜',
          icon: require('../../assets/icon/nav/level.svg'),
          link: 'https://tw.yahoo.com/'
        },
        {
          name: '演出活動',
          icon: require('../../assets/icon/nav/music.svg'),
          link: 'https://tw.yahoo.com/'
        },
        {
          name: '募資計畫',
          icon: require('../../assets/icon/nav/funds.svg'),
          link: 'https://tw.yahoo.com/'
        }
      ],
      navMember: {
        name: '會員專區',
        icon: require('../../assets/icon/nav/check.svg'),
        link: 'https://tw.yahoo.com/'
      },
      navMemberList: [
