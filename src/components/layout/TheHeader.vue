...
<div class="absolute right-10 top-5 sm:flex justify-center items-center space-x-5 hidden">
  ...
  <router-link to="/LoginIn" v-if="!isLogin">
    <button class="border-2 bg-white border-gray-medium w-52 h-10 rounded-3xl  text-gray-dark hover:text-white hover:bg-orange hover:border-opacity-0  ">登入 / 註冊</button>
  </router-link>
  <div v-else class="w-52 flex justify-between items-center border-2 border-gray-medium rounded-3xl inline-block">
