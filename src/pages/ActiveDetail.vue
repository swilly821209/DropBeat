...
`,
  ...
  async created () {
    ...
    const response = await fetch('./DropbeatBackend/active_page_detailMain_get.php', {
      method: 'POST',
      body: form
    })
    ...
    const responses = await fetch('./DropbeatBackend/mussage_act_get.php', {
      method: 'POST',
      body: forms
    })
    ...
    const responseses = await fetch('./DropbeatBackend/active_page_detailMain_join_get.php', {
      method: 'POST',
      body: formes
    })
