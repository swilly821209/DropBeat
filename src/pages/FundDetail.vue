...
export default {
  ...
  async created () {
    ...
    const response = await fetch('./DropbeatBackend/fundsPageDetailMainGet.php', {
      method: 'POST',
      body: form
    })
    // 回傳
    ...
    const responseNow = await fetch('./DropbeatBackend/fundsPageTotalPriceSingle.php', {
      method: 'POST',
      body: formNow
    })
    ...
    const responses = await fetch('./DropbeatBackend/fundsPageDetailOptionGet.php', {
      method: 'POST',
      body: forms
    })
