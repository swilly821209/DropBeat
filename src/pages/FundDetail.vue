...
export default {
  ...
  async created () {
    ...
    const response = await fetch('./DropbeatBackend/funds_page_detailMain_get.php', {
      method: 'POST',
      body: form
    })
    // 回傳
    ...
    const responseNow = await fetch('./DropbeatBackend/funds_page_total_price_single.php', {
      method: 'POST',
      body: formNow
    })
    ...
    const responses = await fetch('./DropbeatBackend/funds_page_detailOption_get.php', {
      method: 'POST',
      body: forms
    })
