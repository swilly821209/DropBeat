<template>
  <div class="range">
    ...
    <div v-for="item in activeDatas"
        :key="item"
        class="flex items-center justify-evenly px-[40px]">
      <base-date :time="item.time" week="true"></base-date>
      <activity-item
        :img="item.imgSrc"
        :title="item.title"
        :time="item.time"
      ...
      <div class="flex space-x-2 self-end mb-6">
      ...
      activeDatas: [
        {
          ...
          title: '《 穿過夜晚 Go Through the Night 》2021 新歌巡迴',
