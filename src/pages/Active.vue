...
export default {
  ...
  methods: {
    ...
    async switchRange (index) {
      ...
      const response = await fetch('./DropbeatBackend/activePageSelectRange.php', {
        method: 'POST',
        body: form
      })
      ...
      const responseses = await fetch('./DropbeatBackend/carouselJoinGet.php', {
        method: 'POST',
        body: forms
      })
  ...
  async created () {
    const response = await fetch('./DropbeatBackend/activePageGet.php')
    const responseData = await response.json()
    responseData.forEach((item) => {
    ...
    const responses = await fetch('./DropbeatBackend/carouselJoinGet.php', {
      method: 'POST',
      body: form
    })
